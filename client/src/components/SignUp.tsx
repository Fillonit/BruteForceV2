...
const SignUp: React.FC<SignUpProps> = ({ setLogIn }) => {
  ...
  return (
    <div className="bg-[url('https://64.media.tumblr.com/7931e97031b430d11b23dfb4a5ca6713/df1a98e7c47a2bff-70/s640x960/26aef91dd548ae2cb09903fe25908ed14d13f267.gif')] bg-no-repeat bg-cover">
      <div className="flex flex-col items-center justify-center h-screen dark:bg-black bg-white dark:bg-opacity-20 bg-opacity-5">
