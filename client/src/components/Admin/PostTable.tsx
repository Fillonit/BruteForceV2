				...
				<Table hoverable>
					...
					<Table.Body className="divide-y">
						{currentPosts.map((post) => (
							<Table.Row
								key={post._id}
								className="bg-white dark:border-gray-700 dark:bg-gray-800 h-[100px]"
							>
					...
					<Modal.Body>
						<div className="space-y-6">
							<p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
								Are you sure that you want to delete post made
								by{" "}
					...
					<button
						...
						className={`mx-1 px-3 py-1 rounded-md ${
							currentPage === index + 1
								...
								: "bg-white text-gray-700 dark:text-white dark:bg-gray-800"
						}`}
