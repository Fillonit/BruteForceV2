  ...
  return (
    <div key={post._id} className="relative font-tektur">
      ...
      <form onSubmit={handleFormSubmit} className="my-4">
        ...
        <button
          type="submit"
          className="bg-white mt-4 p-2 rounded-lg dark:bg-gray-900 dark:text-white text-black text-md w-56"
        >
          Add Comment
        </button>
      </form>
      <div className="border border-gray-400 bg-gray-900 p-4 rounded-lg shadow-lg">
        {post.comments.map((comment) => (
          <div key={comment._id} className="flex items-center space-x-4 my-2">
            <img
