...
const SignIn: React.FC<SignInProps> = ({ setLogIn }) => {
  ...
  return (
    <div className="bg-[url('https://i.imgur.com/TVdmm2k.gif')] bg-no-repeat bg-cover">
      <div className="flex flex-col items-center justify-center h-screen dark:bg-black bg-white dark:bg-opacity-10 bg-opacity-5">
        <form
